...
function searchResults() {
	...
	if (textValue == "") {
		...
		if (innerHTML == "") {
			...
			innerHTML = innerHTML + '<tr><td><input type="text" id="nameField" placeholder="Enter Name.."></td><td><input type="text" id="designationField" placeholder="Enter Designation.."></td><td><img class="avatar" src="http://coenraets.org/apps/angular-directory/pics/james_king.jpg"></td></tr>';
		} else
